...
import { fetchAlarms, acknowledgeAlarm, resolveAlarm, type Alarm, type AlarmLevel } from '../api/client'
...
export default function AlarmCenterPage() {
  ...
  const load = async (targetPage = page) => {
    ...
    try {
      ...
      const data = await fetchAlarms(targetPage, pageSize, level, acknowledged, resolved)
  ...
  }, [autoRefresh, page, levelFilter, statusFilter])
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-gray-500">查看并处理由规则引擎触发的实时告警。</p>
        </div>
